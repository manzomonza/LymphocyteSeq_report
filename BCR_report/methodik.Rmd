...
bcrh_methodik = paste0(gamma_row, collapse = ", ")
...
bcrkl_methodik = paste0(beta_row, collapse = ", ")

```


Sequenz des häufigsten Rearrangements am IGH (V-Gen, J-Gen, CDR3 Aminokörper, CDR3 Nukleotidseq.):  
`r bcrh_methodik`  

Sequenz des häufigsten Rearrangements am IGK/IGL (V-Gen, J-Gen, CDR3 Aminokörper, CDR3 Nukleotidseq.):  
`r bcrkl_methodik`  
